    ...
    for i in x_lt:
        for j in x_lt:
            ...
            if i != j and (j, i) not in i_j_lt: 
                ...
                if p < alpha:
                    text1 = '\033[3;37;41m' + 'Reject Ho and conclude that there is significant evidence, at ' + str(alpha_pct) + '% level of significance, that mean of ' + str(y) + ' for ' + str(i) + ' and mean of ' + str(y) + ' for ' + str(j) + ' is not equal.' + '\033[0;30;0m' 
                    print(text1)
                    
                else: 
                    text2 = '\033[3;37;42m' + 'Do not reject Ho and conclude that there is no significant evidence, at ' + str(alpha_pct) + '% level of significance, that mean of ' + str(y) + ' for ' + str(i) + ' and mean of ' + str(y) + ' for ' + str(j) + ' is equal.' + '\033[0;30;0m' 
                    print(text2) 
