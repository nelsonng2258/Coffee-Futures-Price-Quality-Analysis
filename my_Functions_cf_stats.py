    ...
    for i in x_lt:
        for j in x_lt:
            ...
            if i != j and (j, i) not in i_j_lt: 
                ...
                if p < alpha:
                    text1 = '\033[3;37;41m' + 'Reject Ho and conclude that there is significant evidence, at ' + str(alpha_pct) + '% level of significance, that rank mean of ' + str(y) + ' for ' + str(i) + ' and rank mean of ' + str(y) + ' for ' + str(j) + ' is not equal.' + '\033[0;30;0m' 
                    print(text1)
                    
                else: 
                    text2 = '\033[3;37;42m' + 'Do not reject Ho and conclude that there is no significant evidence, at ' + str(alpha_pct) + '% level of significance, that rank mean of ' + str(y) + ' for ' + str(i) + ' and rank mean of ' + str(y) + ' for ' + str(j) + ' is equal.' + '\033[0;30;0m' 
                    print(text2) 
...
def print_pct_abv_bel_cfp(df, cfp, cat_cfp, ttl_txt):
    ...
    pct_bel_cfp_txt = str(pct_bel_cfp) + '% of the data points are above USD' + str(round(cfp,2)) + ' (' + cat_cfp + ')'
